...
public class RockBuildListIteration
{
    public List<Vector3> unsortedVertexList;

    public List<Vector3> firstQuarter;
    public List<Vector3> secondQuarter;
    public List<Vector3> thirdQuarter;
    public List<Vector3> fourthQuarter;

    public RockBuildListIteration(List<Vector3> vertexPositions)
    {
