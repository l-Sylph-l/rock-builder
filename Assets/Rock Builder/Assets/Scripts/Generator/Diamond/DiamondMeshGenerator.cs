...
namespace RockBuilder
{
    public class DiamondMeshGenerator
    {
        ...
        //    Vector3[] vertices = new Vector3[diamond.edges * 6];
        //    Vector2[] uv = new Vector2[diamond.edges * 6];
        //    int vertexLoop = 0;
        ...
        //            vertices[vertexLoop + 2] = vertexPositions[loopCount + 1] - diamond.transform.position; ;
        //            vertices[vertexLoop + 3] = vertexPositions[diamond.edges + loopCount + 1] - diamond.transform.position;

        //            if (loopCount == 0)
        //            {
        //                uv[vertexLoop] = new Vector2(0f, 1f - uvHeightBody);
        //                uv[vertexLoop + 1] = new Vector2(0f, uvHeightBody);
        //                uv[vertexLoop + 2] = new Vector2(((float)loopCount + 1f) / (float)diamond.edges, uvHeightBody);
        //                uv[vertexLoop + 3] = new Vector2(((float)loopCount + 1f) / (float)diamond.edges, 1f - uvHeightBody);
        //            }
        //            else
        //            {
        ...
        //            vertices[vertexLoop] = vertexPositions[diamond.edges + loopCount] - diamond.transform.position;
        //            vertices[vertexLoop + 1] = vertexPositions[loopCount] - diamond.transform.position;
        //            vertices[vertexLoop + 2] = vertexPositions[0] - diamond.transform.position;
        //            vertices[vertexLoop + 3] = vertexPositions[diamond.edges] - diamond.transform.position;
        ...
        //    int loopCountBody = diamond.edges * 4;
